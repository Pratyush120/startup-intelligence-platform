...
class ScoringEngine:
    ...
    def score(self, features: CompanyFeatures) -> CompanyScore:
        ...
        funding = min(
            features.funding_events * self.FUNDING_WEIGHT,
            30
        )
        ...
        hiring = min(
            features.hiring_events * self.HIRING_WEIGHT,
            20
        )
        ...
        expansion = min(
            features.expansion_events * self.EXPANSION_WEIGHT,
            15
        )
        ...
        acquisition = min(
            features.acquisition_events * self.ACQUISITION_WEIGHT,
            15
        )
