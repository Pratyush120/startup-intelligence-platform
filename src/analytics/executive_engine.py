...
class ExecutiveEngine:
    ...
    def generate(
        ...
        insights.append(
            ...
            f"Funding contributes "

            f"{market.funding_share:.1f}% "

            f"of ecosystem activity."

        )

        insights.append(

            f"Top performing company: "
        ...
        insights.append(
            ...
            f"Highest investment attractiveness: "

            f"{market.highest_investment_company}"

        )

        insights.append(

            f"Dominant business activity: "

            f"{market.dominant_activity}"
        ...
        if market.market_health >= 80:
            ...
            actions.append(
                ...
                "Accelerate strategic investment activities."
            ...
            actions.append(
                ...
                "Continue selective investment in high-growth companies."
        ...
        if market.market_concentration >= 2500:
            ...
            actions.append(
                ...
                "Diversify investment across emerging companies."
        ...
        if market.growth_climate in (
            ...
            actions.append(
                ...
                "Increase focus on rapidly scaling businesses."

            )

        if market.risk_climate in (
            ...
            actions.append(
                ...
                "Strengthen operational risk monitoring."
        ...
        confidence = (
            ...
            f"Average intelligence confidence "

            f"is {market.average_confidence:.2f}."
